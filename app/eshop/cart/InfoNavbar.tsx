    ...
    return (
        <div className={"h-20 flex flex-row flex-start p-5 "}>
            <div className={"justify-center items-center flex flex-row"}>
                ...
                <Link className={"text-black text-[15px] sm:text-[20px]"} href={"/eshop/cart"}>Košík</Link>
            </div>
            <div className={"justify-center items-center flex flex-row "}>
                <div>
                ...
                <Link className={"text-black text-[15px] sm:text-[20px] text-wrap"} href={"/eshop/cart/payment-info"}>Doprava</Link>
            </div>
            <div className={"justify-center items-center flex flex-row"}>
                <div>
                    <div className={"w-6 sm:w-12 bg-gray-400 h-1 rounded relative ml-5"}></div>
                ...
                <Link className={"text-black text-[15px] sm:text-[20px] text-wrap "} href={"/eshop/cart/contact-info"}>Kontaktní údaje</Link>
            </div>
        </div>
    );
}
